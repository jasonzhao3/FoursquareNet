...
int main(int argc, char* argv[]) {
    ...
    TExeTm ExeTm;
    Try
    const TStr InFNm = Env.GetIfArgPrefixStr("-i:", "/Users/jasonzhao/Documents/Courses/CS224W/Project/DataSet/GraphData/undirected_graph_start.txt", "Input graph (undirected graph)");
    const TStr OutFNm = Env.GetIfArgPrefixStr("-o:", "communities_start.txt", "Output file");
